...
lev2 <- lev2 %>% separate(1, c("Chr", "position"), sep = ":", remove = F, convert = FALSE, extra = "merge")
...
R3 <- R3 %>% separate(2, c("Locus2", "Position2"), sep = ":", remove = T, convert = FALSE, extra = "merge") %>% separate(1, c("Locus1", "Position1"), sep = ":", remove = T, convert = FALSE, extra = "merge") %>% separate(4, c("Position1", "SNP1"), sep = "_", remove = T, convert = FALSE, extra = "merge") %>% separate(2, c("Position2", "SNP2"), sep = "_", remove = T, convert = FALSE, extra = "merge")
...
save(maxld, newfile, halfdecay, halfdecaydist, newfile, file = "newfile.RData")
