...
resultFisher_BP <- runTest(myGOdata_BP, algorithm = "weight01", statistic = "ks")
resultFisher_CC <- runTest(myGOdata_CC, algorithm = "weight01", statistic = "ks")
resultFisher_MF <- runTest(myGOdata_MF, algorithm = "weight01", statistic = "ks")

tab_BP <- GenTable(myGOdata_BP, raw.p.value = resultFisher_BP, numChar = 120, topNodes = 20)
tab_CC <- GenTable(myGOdata_CC, raw.p.value = resultFisher_CC, numChar = 120, topNodes = 10)
tab_MF <- GenTable(myGOdata_MF, raw.p.value = resultFisher_MF, numChar = 120, topNodes = 10)
